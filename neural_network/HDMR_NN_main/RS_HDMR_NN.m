...
if (Nnodesini(i)>0),                             % if this mode-term is to be fitted    
 ...
 whichj{i}=1:Nterms;      
    ...
    % save errors
    dlmwrite([label '_' num2str(i) '_errors.dat'],[postmnmx(inputn,minp,maxp); targetn*(maxt-mint)/2]','delimiter','\t', 'precision', '%.6f'); 
    dlmwrite([label '_' num2str(i) '_testerrors.dat'],[postmnmx(testinputn,minp,maxp); testtargetn*(maxt-mint)/2]','delimiter','\t', 'precision', '%.6f');
...
global nn
    ...
    dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], minp','-append','delimiter', '\t', 'precision', '%.6f');
    dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], maxp','-append','delimiter', '\t', 'precision', '%.6f');
    dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], [mint maxt],'-append','delimiter', '\t', 'precision', '%.6f');
    for i=1:Nterms,              
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.LW{2,1},'-append','delimiter', '\t', 'precision', '%.6f');        
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.LW{3,2},'-append','delimiter', '\t', 'precision', '%.6f');        
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.LW{4,3}','-append','delimiter', '\t', 'precision', '%.6f');        
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.b{2},'-append','delimiter', '\t', 'precision', '%.6f');         
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.b{3},'-append','delimiter', '\t', 'precision', '%.6f');        
        dlmwrite([label '_' num2str(modeterm) '_NNs.dat'], NNarray{i}.b{4},'-append','delimiter', '\t', 'precision', '%.6f');        
    end; % for i=1:Nterms    
  ...
  if  0, % only makes sense if the coord transform is linear
      ...
      dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], minp','-append','delimiter', '\t', 'precision', '%.6f');
      dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], maxp','-append','delimiter', '\t', 'precision', '%.6f');
      dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], [mint maxt],'-append','delimiter', '\t', 'precision', '%.6f');
      IW=zeros(Nneurons,D);
      ...
      for t=1:Nterms,              
          ...
          dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], IW,'-append','delimiter', '\t', 'precision', '%.6f');              
          dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], b1new,'-append','delimiter', '\t', 'precision', '%.6f'); 
          dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], NNarray{t}.LW{4,3}','-append','delimiter', '\t', 'precision', '%.6f');              
          dlmwrite([label '_' num2str(modeterm) '_NNs_expnn.dat'], NNarray{t}.b{4},'-append','delimiter', '\t', 'precision', '%.6f');        
      end; % for i=1:Nterms        
  end;
