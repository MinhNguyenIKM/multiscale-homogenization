...
class elementData():
  ...
  def __init__( self , elstate , elDstate ):
    ...
    # minh.nguyen@ikm.uni-hannover.de added this external force as distribution force
    # Create date: 24/09/2018
    self.fdist = zeros(shape=(nDof))
    self.outlabel = []
