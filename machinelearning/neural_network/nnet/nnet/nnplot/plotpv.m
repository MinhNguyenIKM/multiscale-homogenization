...
% $Revision: 1.1.6.5 $  $Date: 2007/11/09 20:51:53 $
...
if (pr > 3), error('NNET:Arguments','P must 1, 2, or 3 rows.'), end
if tr > 3, error('NNET:Arguments','T must have 1, 2, or 3 rows.'), end
