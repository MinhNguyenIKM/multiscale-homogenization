...
% $Revision: 1.1.6.5 $  $Date: 2007/11/09 20:51:49 $
...
if length(w) > 3,error('NNET:Arguments','Weight matrix must not be larger than 3x3.'),end
if br ~= wr, error('NNET:Arguments','Weight matrix & bias vector must have same # of rows.'),end
