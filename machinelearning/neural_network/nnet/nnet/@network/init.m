...
% $Revision: 1.9.4.3 $ $Date: 2007/11/09 20:49:13 $
...
for i=1:net.numInputs
  prange = net.inputs{i}.processedRange;
  if (any(prange(:,1) == prange(:,2)))
    fprintf('\n')
    fprintf('** Warning in INIT\n')
    fprintf('** Network "input{%g}.processedRange" has a row with equal min and max values.\n',i)
