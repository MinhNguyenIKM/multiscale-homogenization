...
% spectral components and cholesterol levels.  The final network is
% analyzed to
% investigate overall performance.
% 
% Copyright 1992-2005 The MathWorks, Inc.
% $Revision: 1.5.2.2 $  $Date: 2005/12/22 18:18:22 $
...
% original units of the targets. Since the targets were transformed using
% mapstd so that the mean was 0 and the standard deviation was 1, we need
% to use mapstd and the original mean and standard deviation (saved in tp)
