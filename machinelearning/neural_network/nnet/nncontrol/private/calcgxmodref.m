...
% $Revision: 1.4.2.2 $ $Date: 2005/12/22 18:18:26 $

%mth 7/29/05  dPerformFcn = feval(net.performFcn,'deriv');
Y = Ac(net.outputConnect,(net.numLayerDelays+1):end);  %mth 7/29/05
E = El(net.outputConnect,:);  %mth 7/29/05
gE = cell(net.numLayers,TS);  %mth 7/29/05
gE(net.outputConnect,:) = feval(net.performFcn,'dy',E,Y,X,perf,net.performParam);  %mth 7/29/05
