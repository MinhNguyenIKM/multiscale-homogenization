...
% $Revision: 1.12.4.1 $  $Date: 2008/10/31 06:24:14 $

if nargin < 2,error('NNET:nwlog:Arguments','Not enough arguments.'); end
if nargout < 2, error('NNET:nwlog:Arguments','Not enough output arguments.'); end
