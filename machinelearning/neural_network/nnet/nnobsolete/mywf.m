...
nntobsf('mywf','Use TEMPLATE_WEIGHT to design your function.')
...
if nargin < 1, error('NNET:mywf:Arguments','Not enough arguments.'); end
...
if isstr(w)
  switch (w)
    ...
    otherwise
      error('NNET:mywf:Arguments','Unrecognized code.')
  end
