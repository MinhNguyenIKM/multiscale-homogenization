...
%  Use TEMPLATE_PERFORMANCE to design your function.

nntobsf('mypf','Use TEMPLATE_PERFORMANCE to design your function.')
...
if nargin < 1, error('NNET:mypf:Arguments','Not enough arguments.'); end
...
if isstr(e)
  ...
  otherwise, error('NNET:mypf:Arguments','Unrecognized code.')
  end
