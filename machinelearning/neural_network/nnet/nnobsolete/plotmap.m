...
% $Revision: 1.11.4.1 $  $Date: 2008/10/31 06:24:19 $

if nargin < 2, error('NNET:plotmap:Arguments','Not enough arguments.'),end
...
[S,R] = size(w);
if R < 2,error('NNET:plotmap:Arguments','W must have at least two columns.'),end
