...
% $Revision: 1.11.4.1 $  $Date: 2008/10/31 06:24:36 $
...
if nargin < 1,error('NNET:solvehop:Arguments','Not enough input arguments.'); end
if nargout < 2, error('NNET:solvehop:Arguments','Not enough output arguments.'); end
