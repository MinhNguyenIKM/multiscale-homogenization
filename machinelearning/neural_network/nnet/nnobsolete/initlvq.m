...
% $Revision: 1.11.4.1 $  $Date: 2008/10/31 06:23:56 $

if nargin < 3,error('NNET:initlvq:Arguments','Not enough input arguments'),end

[r,q] = size(p);
if (q < 2), error('NNET:initlvq:Arguments','First argument has less than 2 columns.'),end
[s2,q] = size(t);
