...
% $Revision: 1.11.4.1 $  $Date: 2008/10/31 06:23:54 $

if all([3 5 7] ~= nargin),error('NNET:initff:Arguments','Wrong number of input arguments'),end

[R,Q] = size(p);
if (Q < 2), error('NNET:initff:Arguments','P must contain at least two elements in each row.'),end
