...
nntobsf('trastd','Use MAPSTD instead.')
...
if nargin ~= 3
  error('NNET:trastd:Arguments','Wrong number of arguments.');
end
...
nequal = ~equal;
if sum(equal) ~= 0
  warning('NNET:trastd:Arguments','Some standard deviations are zero. Those inputs won''t be transformed.');
