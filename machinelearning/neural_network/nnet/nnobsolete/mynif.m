...
nntobsf('mynif','Use TEMPLATE_NET_INPUT to design your function.')
...
if nargin < 1, error('NNET:mynif:Arguments','Not enough arguments.'); end
...
if isstr(n)
  switch n
    ...
    otherwise
      error('NNET:mynif:Arguments','Unrecognized code.')
  end
