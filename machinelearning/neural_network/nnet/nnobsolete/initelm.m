...
% $Revision: 1.11.4.1 $  $Date: 2008/10/31 06:23:53 $

if nargin < 3, error('NNET:initelm:Arguments','Not enough input arguments'); end

% INPUTS
[r,q] = size(p);
if q < 2,error('NNET:initelm:Arguments','First argument has less than 2 columns.'),end
p = [nnminr(p) nnmaxr(p)];
